...
import net.projectzombie.crackshotenhanced.cs.guns.components.AOEAttachments.AOEAttachment;
import net.projectzombie.crackshotenhanced.cs.aoe.modifiers.AOEModifier;
import net.projectzombie.crackshotenhanced.cs.aoe.modifiers.CombustModifier;
import net.projectzombie.crackshotenhanced.cs.aoe.modifiers.ElectricityModifier;
import net.projectzombie.crackshotenhanced.cs.aoe.modifiers.ExplosiveAOEModifier;
import net.projectzombie.crackshotenhanced.cs.aoe.modifiers.FlameAOE;
import net.projectzombie.crackshotenhanced.cs.aoe.modifiers.PoisonAOEModifier;
import net.projectzombie.crackshotenhanced.cs.aoe.modifiers.RadiationAOEModifier;
import net.projectzombie.crackshotenhanced.cs.aoe.modifiers.ShockModifier;
...
public class AOEAttachments extends ModifierConfig<AOEAttachment>
{
    ...
    static public class AOEAttachment extends Attachments.Attachment implements AOEModifier,
            CombustModifier,
            ElectricityModifier,
